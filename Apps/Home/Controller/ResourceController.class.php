...
class ResourceController extends BaseController {
    public function index() {
        ...
        // 广告列表
        $advertList = $this->apiReturnDeal(getApi(array('type' => '34', 'belong' => 1), 'Advert', 'getShows'));
        $this->assign('advertList', $advertList);

        // 热门资源
        $hotList = $this->apiReturnDeal(getApi(array('type' => '3', 'belong' => 1, 'every_num' => 5, 'is_page' => true, 'order' => 'res_hits DESC,res_created DESC', 'size' => '_b'), 'Resource', 'getShows'));
        $this->assign('hotList', $hotList);

        // 小学资源
        $primaryList = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21'), 'school_type' => 15, 'belong' => 1, 'every_num' => 3, 'order' => array('res_hits DESC,res_created DESC'), 'size' => '_b'), 'Resource', 'getShows'));
        $this->assign('primaryList', $primaryList);
        $primaryListNew = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21'), 'school_type' => 15, 'belong' => 1, 'every_num' => 4, 'order' => array('res_created DESC')), 'Resource', 'getShows'));
        $this->assign('primaryListNew', $primaryListNew);

        // 初中资源
        $juniorList = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21,27,24,26,23,25'), 'school_type' => 16, 'belong' => 1, 'every_num' => 3, 'order' => array('res_hits DESC,res_created DESC'), 'size' => '_b'), 'Resource', 'getShows'));
        $this->assign('juniorList', $juniorList);
        $juniorListNew = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21,27,24,26,23,25'), 'school_type' => 16, 'belong' => 1, 'every_num' => 4, 'order' => array('res_created DESC')), 'Resource', 'getShows'));
        $this->assign('juniorListNew', $juniorListNew);

        // 高中资源
        $seniorList = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21,27,24,26,23,25'), 'school_type' => 17, 'belong' => 1, 'every_num' => 3, 'order' => array('res_hits DESC,res_created DESC'), 'size' => '_b'), 'Resource', 'getShows'));
        $this->assign('seniorList', $seniorList);
        $seniorListNew = $this->apiReturnDeal(getApi(array('type' => '2', 'type_ids' => array('19,20,21,27,24,26,23,25'), 'school_type' => 17, 'belong' => 1, 'every_num' => 4, 'order' => array('res_created DESC')), 'Resource', 'getShows'));
        $this->assign('seniorListNew', $seniorListNew);
    ...
    public function search() {
        ...
        // 根据参数查询 检索结果
        $resourceList = $this->apiReturnDeal(getApi(array('type' => '3', 'belong' => 1, 'every_num' => 10, 'is_page' => true, 'page' => $this->current_param['p'], 'keywords' => $keywords), 'Resource', 'getShows'));
    ...
    public function detail() {
        ...
        // 相关
        $relationList = $this->apiReturnDeal(getApi(array('type' => '3', 'belong' => 1, 'every_num' => 6, 'is_page' => true, 'page' => 1, 'subject' => $vo['res_subject']), 'Resource', 'getShows'));
