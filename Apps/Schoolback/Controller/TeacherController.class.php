...
class TeacherController extends SchoolbackController {
    ...
    public function shows() {
        ...
        unset($archives_type[0]);
        unset($archives_type[8]);
        unset($archives_type[9]);
        unset($archives_type[10]);
        $this->assign('archives_type', $archives_type);
        $this->display();
    }
    ...
    public function user() {
        ...
        // 教学能力
        if (intval($_POST['mar_type']) ==7 && $result['list']) {
            // 只能添加一个
        } else {
