 ...
 $(document).ready(function(){
    ...
    $('.res_is_published').live('change', function(){
        $(this).each(function(){
            if ($(this).val() == 1) { // 发布
                $(this).after('<span><input type="checkbox"  class="published_show" name="published_show" value="2">区域</span><span><input type="checkbox"  class="published_show" name="published_show" value="1">平台</span>');
            } else {
    ...
    $('.published_show').live('click', function(){
        var pubVal = 0;
        $(this).parents().find('.published_show').each(function(){
