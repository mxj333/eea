    ...
    $('.res_is_published').live('change', function(){
        $(this).each(function(){
            if ($(this).val() == 1) { // 发布
                ...
                var htm = '<span><input type="checkbox"  class="published_show" name="published_show" value="2"';
                if (local & 2) {
                    htm += ' checked="checked" disabled="disabled" ';
                }
                htm += '>区域</span>';
                htm += '<span><input type="checkbox"  class="published_show" name="published_show" value="1"';
                if (local & 1) {
                    htm += ' checked="checked" disabled="disabled" ';
                }
                htm += '>平台</span>';
